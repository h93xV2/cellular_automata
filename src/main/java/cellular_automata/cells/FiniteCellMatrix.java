...
public final class FiniteCellMatrix implements CellMatrix, Cloneable {
  ...
  public FiniteCellMatrix(final int width, final int height) {
    this(new Cell[width][height]);
  }

  public FiniteCellMatrix(final Cell[][] sourceCells) {
